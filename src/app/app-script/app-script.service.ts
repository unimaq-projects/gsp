...
export class AppScriptService {
  private baseUrl = 'https://script.google.com/a/macros/unimaq.com.pe/s/AKfycbxecIIyy2ol0f8KOjStSec9iEyctXflJ8hHJklC3xCzIWzGV22tMuKSnVtrabKT60Xc/exec';
  ...
  async getRequestById(requestId: number) {
    return this.http.get(`${this.baseUrl}?requestId=${requestId}`, { headers: this.headers })
      .toPromise()
      .then((response: any) => {
        return response.map((workOrder: any) =>
          new WorkorderEntity({
            ...
            complianceMotive: workOrder.Motivo,
